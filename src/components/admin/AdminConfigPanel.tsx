                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="mt-3 grid grid-cols-3 gap-2">
                              {[
                                { label: "شهروند", value: alignmentCounts.CITIZEN, alignment: "CITIZEN" as Alignment },
                                { label: "مافیا", value: alignmentCounts.MAFIA, alignment: "MAFIA" as Alignment },
                                { label: "مستقل", value: alignmentCounts.NEUTRAL, alignment: "NEUTRAL" as Alignment },
