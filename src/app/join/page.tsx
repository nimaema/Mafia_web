...
export default function JoinGamePage() {
  ...
  if (joined) {
    return (
      <div className="bg-surface-dim text-on-surface min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white rounded-lg shadow-lg border border-zinc-200 p-8 flex flex-col items-center text-center gap-6 relative overflow-hidden dark:bg-zinc-900 dark:border-zinc-800 animate-in zoom-in-95">
  ...
  return (
    <div className="bg-surface-dim text-on-surface min-h-screen flex items-center justify-center p-4">
      <main className="w-full max-w-md bg-white rounded-lg shadow-lg border border-zinc-200 p-8 flex flex-col gap-8 relative overflow-hidden dark:bg-zinc-900 dark:border-zinc-800">
        ...
        <form onSubmit={handleJoin} className="flex flex-col gap-4 relative z-10">
          <div className="flex flex-col gap-1">
            ...
            <div className="relative">
              ...
              <input name="gameId" required type="text" dir="ltr" placeholder="مثلاً: 123456" className="w-full bg-gray-200 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg py-3 pl-10 pr-4 focus:border-lime-500 focus:ring-1 focus:ring-lime-500 outline-none transition-colors uppercase font-monor" />
            </div>
          </div>
