...
export default async function DashboardLayout({
  ...
  return (
    <div className="bg-bg-dark text-text-main min-h-screen pb-20 md:pb-0 flex flex-col md:flex-row transition-all duration-500 overflow-hidden" dir="rtl">
      ...
      {/* Desktop Sidebar */}
      <aside className="relative z-10 hidden md:flex flex-col w-80 bg-black/40 backdrop-blur-3xl border-l border-white/5 min-h-screen p-8 sticky top-0 transition-all duration-300 shadow-2xl">
        <div className="flex items-center gap-4 mb-12 px-2">
          ...
          <div className="flex flex-col">
            <h1 className="text-xl font-black tracking-tighter text-white">مافیا پلاس</h1>
            <span className="text-[10px] uppercase tracking-widest text-lime-400 font-bold">Premium Companion</span>
          </div>
        </div>
        
        <nav className="flex flex-col gap-2 flex-grow">
          <Link href="/dashboard/user" className="flex items-center gap-3 px-5 py-4 rounded-2xl transition-all duration-300 hover:bg-white/5 text-zinc-400 hover:text-white group">
          ...
          <Link href="/dashboard/user/history" className="flex items-center gap-3 px-5 py-4 rounded-2xl transition-all duration-300 hover:bg-white/5 text-zinc-400 hover:text-white group">
          ...
          {isModerator && (
            <>
              ...
              <Link href="/dashboard/moderator" className="flex items-center gap-3 px-5 py-4 rounded-2xl transition-all duration-300 hover:bg-white/5 text-zinc-400 hover:text-lime-400 group">
          ...
          {isAdmin && (
            <>
              ...
              <Link href="/dashboard/admin?tab=users" className="flex items-center gap-3 px-5 py-4 rounded-2xl transition-all duration-300 hover:bg-white/5 text-zinc-400 hover:text-blue-400 group">
              ...
              <Link href="/dashboard/admin?tab=roles" className="flex items-center gap-3 px-5 py-4 rounded-2xl transition-all duration-300 hover:bg-white/5 text-zinc-400 hover:text-lime-400 group">
              ...
              <Link href="/dashboard/admin" className="flex items-center gap-3 px-5 py-4 rounded-2xl transition-all duration-300 hover:bg-white/5 text-zinc-400 hover:text-white group">
        ...
        <div className="mt-auto pt-8 flex flex-col gap-4 border-t border-white/5">
          ...
          <form action={handleLogout} className="w-full">
            <button 
              type="submit"
              className="flex items-center gap-3 px-5 py-4 rounded-2xl text-red-400/80 hover:text-red-400 hover:bg-red-500/5 transition-all duration-300 w-full group"
            >
      ...
      <nav className="md:hidden fixed bottom-4 left-4 right-4 bg-zinc-950/80 backdrop-blur-3xl border border-white/10 flex justify-around items-center h-20 z-50 rounded-[2rem] px-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] transition-all">
        ...
        <form action={handleLogout} className="flex-1 h-full">
          <button 
            type="submit"
            className="flex flex-col items-center justify-center w-full h-full gap-1 text-red-500/60 hover:text-red-500"
          >
