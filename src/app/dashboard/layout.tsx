...
export default async function DashboardLayout({
  ...
  return (
    <div className="bg-[#f0f4f8] dark:bg-[#0a0a0c] text-slate-900 dark:text-zinc-100 min-h-screen pb-20 md:pb-0 flex flex-col md:flex-row transition-all duration-500 overflow-hidden" dir="rtl">
      ...
      {/* Desktop Sidebar */}
      <aside className="relative z-10 hidden md:flex flex-col w-80 bg-[#ffffffcc] dark:bg-black/40 backdrop-blur-3xl border-l border-[#0f172a]/10 dark:border-white/5 min-h-screen p-8 sticky top-0 transition-all duration-300 shadow-2xl">
        <div className="flex items-center gap-4 mb-12 px-2">
          ...
          <div className="flex flex-col">
            <h1 className="text-xl font-black tracking-tighter text-white dark:text-white">مافیا بورد</h1>
